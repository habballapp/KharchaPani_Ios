...
const TabNavigator = createMaterialBottomTabNavigator({
    ...
    navigationOptions: {
      tabBarIcon: ({tintColor}) => (
        <View>
          ...
          <Image style={{width: 30, height: 30}} source={AppLogo} />
        </View>
      ),
  ...
  Profile: {
    ...
    navigationOptions: {
      tabBarIcon: ({tintColor}) => (
        <View>
          {/* <Icon style={[{color: tintColor}]} size={25} name={'home'}/>   */}
          <Image style={{width: 30, height: 30}} source={Categories_Image} />
        </View>
      ),
      barStyle: {backgroundColor: '#0d5e50'},
      activeColor: '#0d5e50',
  ...
  User: {
    ...
    navigationOptions: {
      ...
      tabBarIcon: ({tintColor}) => (
        <View>
          <Image style={{width: 35, height: 35}} source={AppLogo1} />
        </View>
      ),
      barStyle: {backgroundColor: '#0d5e50'},
      activeColor: '#0d5e50',
  ...
  Image: {
    ...
    navigationOptions: {
      tabBarIcon: ({tintColor}) => (
        <View>
          {/* <Icon style={[{color: tintColor}]} size={25} name={'home'}/>   */}
          <Image style={{width: 35, height: 35}} source={Logout} />
        </View>
      ),
      barStyle: {backgroundColor: '#0d5e50'},
      activeColor: '#0d5e50',

...
import AppLogo4 from '../../../assets/outdebit.png';
import RNPickerSelect from 'react-native-picker-select';

var Name = '';

export default class OutDebit extends Component {
  ...
  InCreditData() {
    ...
    // Alert.alert(readId);
    fetch(`https://accounts.matz.group/api/debit.php`, {
      method: 'POST',
      headers: {

...
export default class SignUp extends Component {
    ...
    requestLogin() {
        ...
        fetch(`https://accounts.matz.group/api/requestresetpassword.php`, {
            method: 'POST',
            headers: {
                            ...
                            <SafeViewArea style={{ flex: 1 }}>
                                ...
                                <Container ContainerStyle={styles.formContainer}>
                                    ...
                                    <Button
                                        ...
                                        title="Send Email" style={styles.loginButtonStyles} textStyle={styles.loginButtonText} />

                                     <Button
                                        onPress={() =>this.props.navigation.navigate("Login")}
                                        title="Back" style={styles.loginButtonStyles} textStyle={styles.loginButtonText} /> 
